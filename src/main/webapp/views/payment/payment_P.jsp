...
<form action="/projectMenu/payment/paymentReg" name="frm">
<div id = wrap>
<div class="container pb-5 mt-n2 mt-md-n3">
    ...
    <div class="row">
       <div class="col-xl-9 col-md-8">
          <h2 class="h3 mb-4 page-title">결제화면</h2>
            <h2 class="h5 "> <a class="font-size-sm" href="/projectMenu/cart/list">
            <%-- 장바구니옆 <모양 --%>
           
            <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left" style="width: 1rem; 
             height: 1rem;"><polyline points="15 18 9 12 15 6"></polyline></svg>장바구니</a>
             </h2>

    <!-- 상품-->
   <c:forEach items="${data.pay_prod }" varStatus="no" var="vo">
               <div class=" justify-content-between my-4 pb-4 border-bottom">
                   <div class="media d-block d-sm-flex text-center text-sm-left">
                       <%--  <a class="cart-item-thumb mx-auto mr-sm-4" href="#"><img src="/img/${vo.p_image }" alt="${vo.p_image }"></a>  --%>
                       <div class="media-body pt-3"> <!-- 상품명 -->
                          ...
                          <!--  <div class="font-size-sm"><span class="text-muted1 mr-2">옵션:</span>3M 레몬컬러</div> -->
                           ...
                           <div class="font-size-lg text-primary pt-2" > 가격 : ${(vo.money)}</div>   
                       </div>
                      </div>
                  </div>        
       <c:set var="t_totalprice" value="${t_totalprice+ vo.money}"/>    <!-- 총가격 누적 -->  
       <c:set var="t_amount" value="${t_amount+ vo.p_amount}"/>   
       <c:set var="t_pname" value="${t_pname}${vo.p_name},${vo.p_amount}/"/>   
       <c:set var="name" value="${name}${vo.c_code},"/>   
             ...
             <div class=" col-md-6 ">
                ...
                <h2 class="h6 px-4 bg-secondary text-center">+ 배송비 3000</h2>
                  ...
                  <div class="h3 font-weight-semibold text-center py-3">${(t_totalprice+3000) }원   
               
                     <input type="hidden" name="t_totalprice" value="${(t_totalprice+3000) }">
 ...
 <!-- 주소등의 입력 칸 -->
<c:set var="vo" value="${data.customervo }"/>  
        <div class="container">
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto">
        ...
        <div class="my-4">
                <hr class="my-4" />
                <div class="form-row">
                         <input type="hidden" name="t_pid" value="${vo.id}">
                    <div class="form-group col-md-6">
                        <label for="firstname">주문자명</label>
                        <input type="text" id="name" class="form-control-p" name="t_recipient" value="${vo.name}"  />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="lastname">연락처</label>
                        <input type="tel" id="tel" class="form-control-p" name="t_r_phone" value="${vo.tel}"  />
                    </div>
                </div>
             
                <div class="form-group">
                    <label for="inputAddress5">주소</label>
                    <input type="text" class="form-control-p" id="zipcode" name="t_r_zipcode" value="${vo.zipcode}"  />
                    <input type="button" value="우편번호찾기" onclick="exePostCode();" class="btn btn-sm btn-secondary">
                </div>
                    <div class="form-group ">
                        <label for="inputCompany5">상세주소</label>
                        <input type="text" class="form-control-p" id="address" name="t_r_adress" value="${vo.address}" />
                    </div>
                    <div class="form-group">
            ...
            <input type="radio" name="t_payment" value="card" checked="checked"/>카드결제
               ...
               <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="card1"  class="form-control-p" name="card1" />
                    </div> 
                    <div class="form-group col-md-3">
                       <label>입력</label>
                        <input type="text" id="card2" class="form-control-p" name="card2" />
                    </div> 
                    <div class="form-group col-md-3">
                          <label>&nbsp;_</label>
                        <input type="text" id="card3" class="form-control-p" name="card3" />
                    </div> 
                    <div class="form-group col-md-3">
                       <label>&nbsp;_</label>
                        <input type="text" id="card4" class="form-control-p" name="card4" />
                    </div>
                </div>
...
<!--                 <button type="submit" class="btn btn-primary">배송사항 변경</button> -->
                ...
                <!-- 여기부터 결제수단 동의확인 -->
                <hr class="my-4" />
           <input type="hidden" name="consent" checked="checked"/>
        ...
        <div class=" col-md-6 ">
         <!-- 제출버튼 -->
         <input type="button"   value="결제하기" id="submitChk" <a class="btn btn-primary btn-block" href="Join_Success">
  ...
  <!--   <a class="btn btn-primary btn-block" href="Join_Success">
                <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card mr-2">
