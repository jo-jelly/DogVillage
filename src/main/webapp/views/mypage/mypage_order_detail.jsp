...
<section>
	...
	<article>
			...
			<div class="div2">
				<h6>
					결제방법 : ${vo.t_payment }<br><br>
					배송비 : ${vo.t_fee }원<br><br>
					결제일시 : <fmt:formatDate value="${vo.t_bdate }" pattern="yy-MM-dd HH:mm"/><br><br>
					결제금액 : ${vo.t_totalprice }원<br><br>
				</h6>
			</div>
	</article>
	...
	<article>
			...
			<div class="div4">
				<h6>
					송장번호 : ${vo.t_invoicen }<br><br>
					배송일자 : ${vo.t_date }<br><br>
					받는 분 : ${vo.t_recipient }<br><br>
					받는 분 연락처 : ${vo.t_r_phone }<br><br>
					주소 : ${vo.t_r_zipcode }<br><br>
					상세주소 : ${vo.t_r_adress } <br><br>
				</h6>
			</div>
	</article>
